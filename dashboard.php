...
<section class="people">
    ...
    <div class="col-md-4" style="margin-bottom:20px;">
        <div class="card" >
                ...
                <div>
                  <center>
                    <model-viewer camera-controls alt="Model" src="control/common_models/thumb/<?php echo $val['thumb_model'];?>"
            ...
            <div class="card-body" style="background: #292a2d; border: none;margin:0px;">
              ...
              <h3 class="name-pos mb-0" ><a href="#"><?php echo $val['name']?></a></h3>
             <p class="card-text text-white">Some example text some example text. John Doe is an architect and engineer</p>
         
             <a href="control/pages/<?php echo $val['link']?>" target="_blank" > <button type="button" class="btn btn-primary btn-md mt-2"><i class="fa fa-eye mr-2"></i>&nbsp;View</button></a>
             <a href="control/pages/<?php echo $val['link'].'/list.php'?>" target="_blank" > <button type="button" class="btn btn-info btn-md mt-2"><i class="fa fa-cog mr-2"></i>&nbsp;Settings</button></a>
            </div>
          </div>
