   ...
   <div class="container-fluid content-top-gap back-g mb-5">
      <section class="people">
         <section class="w3l-team-block ">
            ...
            <!--   </div>-->
            <!--</div>-->
            <?php foreach ($order_id_array as $key => $value) { ?>
            <div class="card Rectangle-242 mb-5">
               <div class="card-body">
                  <h4 class="card-title text-primary">#<?php echo $value; ?></h4>
                  <a  href="https://dashboard.razorpay.com/app/orders/<?php echo $value; ?>" style="float: right;" target="_blank"><b class="mt-4 mb-4 text-info">Go to payment page</b></a>
                  ...
                  <div class="text-info mt-2">
                     <p style="text-align: end;margin: 15px;" class="text-info" >Item Total: <b id="totalAmount" style="color:black;"><?php echo $total; ?> INR</b></p>
                     <p style="text-align: end;margin: 15px;" class="text-info">Tax: <b style="color:black;">0 INR</b></p>
                     <p style="text-align: end;margin: 15px;" class="text-primary">Total amount: <b id="totalAmount2" style="color:black;"><?php echo $total; ?> INR</b></p>
                  </div>
               </div>
            </div>
            <?php } ?>
