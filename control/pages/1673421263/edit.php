<?php $table_name='1673421263_meta_product_table';?><?php
...
<div class="container-fluid content-top-gap">
   ...
   <section class="people">
    ...
    <div class="form-group">
      ...
      <input type="text" class="form-control"  placeholder="Scale" name="scale"  value="<?php echo $get_data[0]["scale"] ?>">
    </div>
    
    <div class="form-group">
      <label for="pwd">Rotation</label>
      <input type="text" class="form-control"  placeholder="Rotation" name="rotation"  value="<?php echo $get_data[0]["rotation"] ?>">
    </div>
    <div class="form-group">
    ...
    <!--  <input type="file" name="image"  class="form-control"  value="<?php $get_data[0][
        "glb_model"
    ] ?>">-->
    <!--</div>-->
    ...
    <div class="form-group">
            <center>
                ...
                <model-viewer camera-controls alt="Model" src="models/<?php echo $get_data[0]["glb_model"] ?>" shadow-intensity="1" camera-controls touch-action="pan-y" style="height:549px">
                </model-viewer>
