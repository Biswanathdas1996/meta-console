...
<div class="container-fluid content-top-gap">
   ...
   <section class="people">
            <section class="w3l-team-block">
                ...
                <div class="card card_border mb-5">
                    <div class="cards__heading">
                        <h3>Update <?php $get_data[0]["name"] ?></h3>
                    </div>
                    <div class="card-body">
    ...
    <div class="form-group">
      ...
      <input type="text" class="form-control"  placeholder="Enter title" name="name" value="<?php $get_data[0][
          "name"
      ] ?>">
    </div>
    ...
    <div class="form-group">
      ...
      <input type="text" class="form-control"  placeholder="Enter price" name="price" value="<?php $get_data[0][
          "price"
      ] ?>">
    </div>
    <div class="form-group">
      <label for="pwd">Description</label>
      <input type="text" class="form-control"  placeholder="Description" name="desc" value="<?php $get_data[0][
          "description"
      ] ?>">
    </div>
    ...
    <div class="form-group">
      ...
      <input type="number" class="form-control"  placeholder="Inventory" name="qty" value="<?php $get_data[0][
          "qty"
      ] ?>">
    </div>
    ...
    <div class="form-group">
      ...
      <input type="text" class="form-control"  placeholder="Scale" name="scale"  value="<?php $get_data[0]["scale"] ?>">
    </div>
    
    <div class="form-group">
      <label for="pwd">Rotation</label>
      <input type="text" class="form-control"  placeholder="Rotation" name="rotation"  value="<?php $get_data[0]["rotation"] ?>">
    </div>
    <div class="form-group">
      <label for="pwd">Custom vertical position</label>
      <input type="text" class="form-control"  placeholder="Custom position vertical" name="custom_position_vertical" value="<?php $get_data[0][
    ...
    <div class="form-group">
            <center>
                ...
                <model-viewer camera-controls alt="Model" src="models/<?php $get_data[0]["glb_model"] ?>" shadow-intensity="1" camera-controls touch-action="pan-y" style="height:549px">
                </model-viewer>
