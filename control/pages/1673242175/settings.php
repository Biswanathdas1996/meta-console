<?php $table_name='1673242175_meta_product_table';?><?php
          ...
          $thumb_model = $_POST['thumb_model'];
            ...
            if ($_FILES["wall_video"]['error'] === 0) {
               ...
               $file_data_videos = round(microtime(true)) . '.' .'mp4';
                if (empty($errors) == true) {
                        copy($file_tmp, "../../common_models/videos/" . $file_data_videos);
            ...
            $insert_shop_data = update('meta_shop_lists',[
                                "data"=>[
             ...
             $shop_name_position_updated = $_POST['shop_name_position_X']." ".$_POST['shop_name_position_Y']." ".$_POST['shop_name_position_Z'];
             
             if($_POST['prev_shop_position'] == $_POST['position']){
                
                $update_location_data = update('land_locations',[
                                "data"=>[
                                        "shop_name_position"=>$shop_name_position_updated,
                                        "position"=>$_POST['shop_position'],
                                        "on_exit_camers_position"=>$_POST['on_exit_camers_position'],
           ...
           $update_publish_status = update('meta_shop_lists',[
                                "data"=>[
                                        "status"=>$status,
                                    ]
                                ],$_POST['shop_id']);
                           ...
                           <div class="Rectangle-242 mt-5">
                                      ...
                                      <form class="idForm" method="POST" enctype="multipart/form-data" >
                                        <div style="text-align: right;">
                                          <input type="hidden" class="form-control" name="shop_id" value="<?php echo $get_data[0]['id']?>" />
                                          <?php if($get_data[0]['status'] == 1){ ?>
                                   ...
                                   <input type="hidden" class="form-control" name="shop_id" value="<?php echo $get_data[0]['id']?>" />
                                      <div class="form-group my-5">
                                         ...
                                         <input type="text" class="form-control" name="blank_name" placeholder="Enter shop name *"
                                            value="<?php echo $get_data[0]['name']?>" /> 
                                      </div>
                                      ...
                                      <div class="col-md-4 mt-5">
                                       <div class="form-group mt-3">
                                          ...
                                          <input type="text" class="form-control" name="shop_name_rotation" placeholder="Enter shop name rotation *"
                                             value="<?php echo $get_data[0]['land_locations']['shop_name_rotation'];?>" /> 
                                       </div>
                                    </div>
                                      <div class="col-md-4 mt-5">
                                       <div class="form-group mt-3">
                                          ...
                                          <input type="text" class="form-control" name="shop_name_scale" placeholder="Enter shop name scale *"
                                             value="<?php echo $get_data[0]['land_locations']['shop_name_scale'];?>" /> 
                                       </div>
                                    </div>
                                      <div class="col-md-4 mt-5">
                                       <div class="form-group mt-3">
                                          ...
                                          <input type="text" class="form-control" name="shop_name_color" placeholder="Enter shop name color *"
                                             value="<?php echo $get_data[0]['land_locations']['shop_name_color'];?>" /> 
                                       </div>
                                    </div>
                                    </div>
                                      ...
                                      <div class="col-md-12 mt-3" >
                                       <div class="form-group">
                                          ...
                                          <select class="form-control" name="direct_entry">
                                             ...
                                             <option value="1" <?php if ($get_data[0]['direct_entry'] == 1) { echo "selected"; } ?>>
                                                Do not ask visitors identity before entering the shop
                                             </option>
                                             <option value="0" <?php if ($get_data[0]['direct_entry'] == 0) { echo "selected"; } ?>>
                                                Ask visitors identity before entering the shop
                                             </option>
                                            
                                          </select>
                                          <input type="hidden" class="form-control" name="prev_shop_position" value="<?php echo $get_data[0]['land_locations_id']; ?>" /> 
                                       </div>
                                    </div>
                                    </div>
                              ...
                              <div class="Rectangle-242 mt-5">
                                 ...
                                 <div class="row">
                                    <div class="col-md-4 " style="height:400px;">
                                       ...
                                       <div class="form-check mt-3">
                                          <input type="radio" class="form-check-input" id="radio1" name="thumb_model"
                                             value="shop_thumb_1.glb" <?php if( $get_data[0]['thumb_model'] == 'shop_thumb_1.glb') echo "checked"; ?> />
                                    ...
                                    <div class="col-md-4 " style="height:400px;">
                                       ...
                                       <div class="form-check mt-3">
                                          <input type="radio" class="form-check-input" id="radio2" name="thumb_model"
                                             value="shop_thumb_2.glb" <?php if( $get_data[0]['thumb_model'] == 'shop_thumb_2.glb') echo "checked"; ?>/>
                                    ...
                                    <div class="col-md-4 " style="height:380px;">
                                       ...
                                       <div>
                                          <center>
                                             <model-viewer camera-controls alt="Model" src="../../common_models/thumb/<?php echo $get_data[0]['thumb_model']; ?>"
                                                shadow-intensity="1" camera-controls touch-action="pan-y"
                                                style="height:285px; width:100%; border:1px solid #80808038; border-radius: 30px;">
                                             </model-viewer>
                                             <input type="radio" class="form-check-input" id="radio2" name="thumb_model"
                                                value="<?php echo $get_data[0]['thumb_model']; ?>" <?php if( $get_data[0]['thumb_model'] != 'shop_thumb_2.glb' && $get_data[0]['thumb_model'] != 'shop_thumb_1.glb') echo "checked"; ?>/>
                                    ...
                                    <div class="col-md-6 mt-5">
                                       <div class="form-group mt-3">
                                          ...
                                          <input type="text" class="form-control" name="thumb_model_scale" placeholder="Enter thumb model scale *"
                                             value="<?php echo $get_data[0]['thumb_model_scale'];?>" /> 
                                       </div>
                                    </div>
                                    <div class="col-md-6 mt-5">
                                       <div class="form-group mt-3">
                                          ...
                                          <input type="text" class="form-control" name="thumb_model_rotation" placeholder="Enter thumb model rotation *"
                                             value="<?php echo $get_data[0]['thumb_model_rotation'];?>" /> 
                                       </div>
                                    </div>
                                    </div>
                                ...
                                <div class="Rectangle-242 mt-5">
                                    ...
                                    <div class="col-md-4 mt-1" style="height:400px;">
                                       ...
                                       <div class="form-check mt-3">
                                          <input type="radio" class="form-check-input" id="rack" name="rack"
                                             value="Stand.glb" <?php if($get_data[0]['rack'] == 'Stand.glb') echo 'checked'; ?>>Stand 1
                                    ...
                                    <div class="col-md-4 mt-1" style="height:400px;">
                                       ...
                                       <div class="form-check mt-3">
                                          <input type="radio" class="form-check-input" id="rack" name="rack"
                                             value="Stand2.glb" <?php if($get_data[0]['rack'] == 'Stand2.glb') echo 'checked'; ?>>Stand 2
                                          <label class="form-check-label" for="rack"></label>
                                       </div>
                                    </div>
                                    <div class="col-md-4 mt-1" style="height:400px;">
                                       ...
                                       <div class="form-check mt-3">
                                          <input type="radio" class="form-check-input" id="rack" name="rack"
                                             value="Stand3.glb" <?php if($get_data[0]['rack'] == 'Stand3.glb') echo 'checked'; ?>>Stand 3
                                          <label class="form-check-label" for="rack"></label>
                                       </div>
                                    </div>
                                    <!----------------------------rack end      -->
                                    <div class="col-md-12 mt-3" >
                                       <div class="form-group">
                                          ...
                                          <input type="number" class="form-control" name="stand_qty" placeholder="Enter no of stand(s) *"
                                             value="<?php echo $get_data[0]['stand_qty']?>" />
                                       </div>
                                    </div>
                                      </div> 
                                </div> 
                                      ...
                                      <div class="col-md-12 mt-3" >
                                       <div class="form-group">
                                          ...
                                          <select class="form-control" name="position">
                                             ...
                                             <option value="<?php echo $value['id']?>" <?php if ($get_data[0]['land_locations_id'] == $value['id']) { echo "selected"; } ?>>
                                                <?php echo $value['name']?>
                                             </option>
                                             <?php } ?>
                                          </select>
                                    ...
                                    <div class="col-md-12 mt-3" style="display:flex;">
                                       <div class="form-group mr-5">
                                          ...
                                          <input type="text" class="form-control" name="shop_position" placeholder="Enter position *"
                                             value="<?php echo $get_data[0]['land_locations']['position'];?>" /> 
                                       </div>
                                       <div class="form-group mr-5">
                                          ...
                                          <input type="text" class="form-control" name="on_exit_camers_position" placeholder="Enter on_exit_camers_position *"
                                             value="<?php echo $get_data[0]['land_locations']['on_exit_camers_position'];?>" /> 
                                       </div>
                                       ...
                                       <div class="form-group mr-5">
                                          ...
                                          <input type="text" class="form-control" name="link_door_position" placeholder="Enter link_door_position *"
                                             value="<?php echo $get_data[0]['land_locations']['link_door_position'];?>" /> 
                                       </div>
                                       <div class="form-group mr-5">
                                          ...
                                          <input type="text" class="form-control" name="link_door_rotation" placeholder="Enter link_door_rotation *"
                                             value="<?php echo $get_data[0]['land_locations']['link_door_rotation'];?>" /> 
                                       </div>
                                ...
                                <div class="Rectangle-242 mt-5">
                                      ...
                                      <div class="col-md-6 mt-3" >
                                       <div class="form-group mt-3" >
                                          ...
                                          <input type="hidden" class="form-control" name="wall_video_name" value="<?php echo $get_data[0]['wall_video']?>" />
                                       </div>
                                    </div>
                                    <div class="col-md-6 mt-3" >
                                       <center>
                                          <video width="500" controls>
                                             <source src="../../common_models/videos/<?php echo $get_data[0]['wall_video']?>" type="video/mp4">
