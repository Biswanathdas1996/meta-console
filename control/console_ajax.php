    ...
    if (
        ...
        if (isset($_POST['blank_name'])) {
            ...
            $sql = "CREATE TABLE $table_name(
                                    ...
                                    custom_position_vertical VARCHAR(355) NULL,
                                    status INT
                                        (11) NULL
                                )";
            ...
            ($fp = fopen($actual_link_put_add_page, 'a+')) or
                die("can't open file");
            $theOldData = fread($fp, filesize($actual_link_put_add_page));
            fclose($fp);
            ($fp = fopen($actual_link_put_add_page, 'w+')) or
                die("can't open file");
            ...
            ($fp3 = fopen($actual_link_put_list_page, 'a+')) or
                die("can't open file");
            $theOldData3 = fread($fp3, filesize($actual_link_put_list_page));
            fclose($fp3);
            ($fp3 = fopen($actual_link_put_list_page, 'wb')) or
                die("can't open file");
            ...
            ($fp4 = fopen($actual_link_put_edit_page, 'a+')) or
                die("can't open file");
            $theOldData4 = fread($fp4, filesize($actual_link_put_edit_page));
            fclose($fp4);
            ($fp4 = fopen($actual_link_put_edit_page, 'wb')) or
                die("can't open file");
            ...
            ($fp5 = fopen($actual_link_put_delete_page, 'a+')) or
                die("can't open file");
            $theOldData5 = fread($fp5, filesize($actual_link_put_delete_page));
            fclose($fp5);
            ($fp5 = fopen($actual_link_put_delete_page, 'wb')) or
                die("can't open file");
            ...
            ($fp6 = fopen($actual_link_put_order_page, 'a+')) or
                die("can't open file");
            $theOldData6 = fread($fp6, filesize($actual_link_put_order_page));
            fclose($fp6);
            ($fp6 = fopen($actual_link_put_order_page, 'wb')) or
                die("can't open file");
            ...
            $actual_link_put__lead_page = 'pages/' . $newpage . '/visitors.php';

            ($fp7 = fopen($actual_link_put__lead_page, 'a+')) or
                die("can't open file");
            $theOldData7 = fread($fp7, filesize($actual_link_put__lead_page));
            fclose($fp7);
            ($fp7 = fopen($actual_link_put__lead_page, 'wb')) or
                die("can't open file");
            $toBeWriteToFile7 = $data . $theOldData7;
            fwrite($fp7, $toBeWriteToFile7);
            fclose($fp7);
            ...
            $actual_link_put__settings_page =
                'pages/' . $newpage . '/settings.php';

            ($fp8 = fopen($actual_link_put__settings_page, 'a+')) or
                die("can't open file");
            $theOldData8 = fread(
                $fp8,
                filesize($actual_link_put__settings_page)
            );
            fclose($fp8);
            ($fp8 = fopen($actual_link_put__settings_page, 'wb')) or
                die("can't open file");
            $toBeWriteToFile8 = $data . $theOldData8;
            fwrite($fp8, $toBeWriteToFile8);
            fclose($fp8);
